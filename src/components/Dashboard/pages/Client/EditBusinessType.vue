<template>
  <div class="pg-edit-business-type">
    <div class="card p-4">
...
div.pg-edit-business-type th {
  text-transform: capitalize;
}
div.pg-edit-business-type h4 {
  text-transform: capitalize;
}
div.pg-edit-business-type .el-select,
div.pg-edit-business-type .el-date-editor {
  width: 100%;
}
div.pg-edit-business-type div#accordion div.card-header i.nc-icon {
  color: #8d8d8d;
}
</style>