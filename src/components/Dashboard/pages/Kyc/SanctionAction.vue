      ...
      <div class="row mb-4">
        ...
        <div class="col-6 text-right">
          <p-button round class="btn btn--close btn--shadow mr-1"
                    v-if="hasPermission(permission.KYC_SANCTION_ACTION_CLOSE)"
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="d-flex w-mn">
                  ...
                  <el-popover v-if="sancheck.applicationStatus" placement="bottom right" width="490"
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div v-if="sancheck.latestResubmittedDate" class="d-flex w-mn">
                  ...
                  <p-button round class="btn btn--browse m-0" @click.stop.prevent="doRescreenNow()">Rescreen Now
                  </p-button>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="d-flex align-items-center">
                  <p class="mr-4 status-label" :class="cardBtnSancStatus" v-if="sancheck && sancheck.checkStatusName">{{
                    sancheck.checkStatusName }}</p>

                  <el-popover v-model="actionPopup" placement="left-end" popper-class="actionPopover" :offset="500"
                              :visible-arrow="false" width="700" class="status-helper" trigger="click">
                    <div class="container-fluid">
                      <div class="row mt-3 mb-2">
                        <div class="col">
                          <p class="kyc-label kyc-label--big">Action Sanction <span
                            class="d-inline-block ml-1 mr-3 clr-purple">* </span>
                      ...
                      <div class="row mb-5">
                        <div class="col">
                          <el-select size="small" class=" mr-3 particulars-input" placeholder="Action"
                                     v-model="manualUpdate.actionTypeCode">
                            <el-option v-for="(type, index) in actionDropDown" class="select-success" :value="type.code"
                                       :label="`${type.description}`" :key="index"/>
                          </el-select>
                        </div>
                      </div>
                      ...
                      <div class="row mb-1">
                        ...
                        <div class="col-6 text-right">
                          <div class="d-flex justify-content-end align-items-center">
                            ...
                            <p-button :disabled="sending" v-if="file" round class="btn btn--upload"
                                      @click.stop.prevent="doUploadSupportDocument">
                      ...
                      <div class="row mb-4">
                        <div class="col text-center">
                          <p-button round class="btn btn--save btn--shadow mr-3" @click.stop.prevent="doManualUpdate">
                            Save
                          </p-button>
                          <p-button round class="btn btn--cancel btn--shadow" @click.stop.prevent="closeActionPopup">
                            Cancel
                          </p-button>
                        </div>
                      </div>
                    ...
                    <p-button v-if="hasPermission(permission.KYC_SANCTION_ACTION)"
                              :disabled="sancheck.checkStatusName == 'No Match' || sancheck.checkStatusName == 'Manual Approved'"
                              slot="reference" round class="btn btn--close btn--shadow bg-sanction">Action
                    </p-button>
                  </el-popover>
                </div>
              </div>
        ...
        <div class="col-xl-4">
          <div class="kyc-info-box">
            <div class="row" v-for="(item, k) in sancheck.watchlistHitResult.hitDetails" :key="k">
              ...
              <div class="col-6"><p class="kyc-value w-mn pointer color-primary hover"
                                    @click.stop="screenDetailsIndx = k">{{ item.name }}</p></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row mb-5" v-if="screenDetails">
        <div class="col">
          <div class="screenDetails p-3">
            ...
            <div class="row mb-4">
              <div class="col">
                <div class="d-flex"><p class="kyc-label d-inline-block mr-2" style="width: 150px">Name</p>
                  <p class="kyc-label d-inline rec-value">{{ screenDetails.name }}</p></div>
              </div>
            </div>
            <div class="row mb-3 py-3" v-for="(item, k) in screenDetails.fields" :key="k"
                 :class="{ 'bg-primary-light': k%2 == 0 }">
              ...
              <div class="col">
                <div class="">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="d-flex"><p class="kyc-value d-inline-block mr-2" style="width: 150px">Name</p>
                        <p class="kyc-value d-inline rec-value">{{ item.name }}</p></div>
                      <div class="d-flex"><p class="kyc-value d-inline-block mr-2" style="width: 150px">Source</p>
                        <p class="kyc-value d-inline rec-value">{{ item.source }}</p></div>
                      <div class="d-flex"><p class="kyc-value d-inline-block mr-2" style="width: 150px">Details</p>
                        <p class="kyc-value d-inline rec-value">{{ item.value }}</p></div>
                    </div>
                  </div>
                </div>
              </div>
