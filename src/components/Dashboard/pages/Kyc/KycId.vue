  ...
  <div>
      ...
      <div class="row mb-4">
        ...
        <div class="col-6 text-right">
          <p-button round class="btn btn--close btn--shadow mr-1"
                    v-if="hasPermission(permission.KYC_ID_VIEW)"
                    @click.stop.prevent="close">Close
          </p-button>
        </div>
      </div>
          ...
          <div class="kyc-info-box">
            ...
            <div class="row">
              ...
              <div class="col-6">
                ...
                <el-popover v-if="idCheck.checkStatusName" placement="bottom right" width="690" class="status-helper"
                            trigger="hover">
      ...
      <div class="container-fluid pt-3">
        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-xl-6 mb-3">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <p class="m-0 mr-4 status-label" :class="idCheckStatusClass"
                     v-if="idCheck && idCheck.checkStatusName">{{ idCheck.checkStatusName }}</p>

                </div>
              </div>
              <div class="col-xl-6 mb-3">
                <kyc-id-action v-if="$route.name == 'KYC Id Action' && hasPermission(permission.KYC_ID_ACTION)"
                               @refresh="start"
                               :id="id"
            ...
            <div class="row mb-3">
              <div class="col-xl-6 mb-xl-0 mb-4">
                <div class="client-info">
                  ...
                  <el-card class="client-info__card" :body-style="{ padding: '0px' }">
                    <el-popover v-if="gettersCheckDocs && gettersCheckDocs.ID_FRONT" placement="right" width="550"
                                class="image-zoom" trigger="hover">
                      <img class="w-100"
              ...
              <div class="col-xl-6 mb-xl-0 mb-4">
                <div class="client-info">
                  ...
                  <el-card class="client-info__card" :body-style="{ padding: '0px' }">
                    <el-popover v-if="gettersCheckDocs && gettersCheckDocs.ID_BACK" placement="right" width="550"
                                class="image-zoom" trigger="hover">
                      <img class="w-100"
          ...
          <div class="col-xl-4">
            ...
            <div class="row mb-3"
                 :class="{ 'mt-37': gettersCheckDocs && gettersCheckDocs.ID_BACK || ($route.query.action && id)}">
              <div class="col mb-xl-0 mb-4">
                <div class="client-info">
                  <p class="mb-0 kyc-label invisible d-none d-xl-block">.</p>
                  <el-card class="client-info__card" :body-style="{ padding: '0px' }">
                    <el-popover v-if="gettersCheckDocs && gettersCheckDocs.SELFIE" placement="right" width="550"
                                class="image-zoom" trigger="hover">
                      <img class="w-100"
            ...
            <div class="row mb-3">
              <div class="col mb-xl-0 mb-4">
                <div class="client-info">
                  ...
                  <el-card class="client-info__card" :body-style="{ padding: '0px' }">
                    <el-popover v-if="gettersCheckDocs.SIGNATURE" placement="right" width="550" class="image-zoom"
                                trigger="hover">
                      <img class="w-100"
                           :src="`data:${gettersCheckDocs.SIGNATURE.mimeType};base64, ${gettersCheckDocs.SIGNATURE.content}`">
                      <img class="client-info__card__img" slot="reference" v-if="gettersCheckDocs.SIGNATURE"
                           :src="`data:${gettersCheckDocs.SIGNATURE.mimeType};base64, ${gettersCheckDocs.SIGNATURE.content}`">
                    </el-popover>
                    <div v-else class="client-info__card__info d-flex justify-content-center align-items-center">
                      <p>No document received</p>
            ...
            <div class="row mb-3">
              <div class="col mb-xl-0 mb-4">
                <div class="client-info">
                  <p class=" kyc-label invisible d-none d-xl-block">.</p>
                  <el-card class="client-info__card" :body-style="{ padding: '0px' }">
                    <el-popover v-if="gettersCheckDocs.PROFILE" placement="right" width="550" class="image-zoom"
                                trigger="hover">
                      <img class="w-100"
                           :src="`data:${gettersCheckDocs.PROFILE.mimeType};base64, ${gettersCheckDocs.PROFILE.content}`">
                      <img class="client-info__card__img" slot="reference" v-if="gettersCheckDocs.PROFILE"
                           :src="`data:${gettersCheckDocs.PROFILE.mimeType};base64, ${gettersCheckDocs.PROFILE.content}`">
                    </el-popover>
                    <div v-else class="client-info__card__info d-flex justify-content-center align-items-center">
                      <p>No document received</p>
    ...
    <div class="container-fluid">
      <div class="row mt-5">
        <div class="col">
          <h3 class="kyc__section__header">ID Data Return Fields
            <el-popover v-if="validationData" placement="bottom right" width="100%" class="status-helper"
                        trigger="hover">
              <h5 class="sub-title">Status Legend</h5>
              <table class="helper-table">
                <tbody>
                <tr v-for="(item, i) in validationData.halfLength" :key="i">
                  <td v-if="validationData.leftSide[i]">
                    <div class="kyc-label">{{ validationData.leftSide[i].name }}</div>
                  </td>
                  <td v-if="validationData.leftSide[i]">
                    <div class="kyc-value">{{ validationData.leftSide[i].remark }}</div>
                  </td>

                  <td v-if="validationData.rightSide[i]">
                    <div class="kyc-label">{{ validationData.rightSide[i].name }}</div>
                  </td>
                  <td v-if="validationData.rightSide[i]">
                    <div class="kyc-value">{{ validationData.rightSide[i].remark }}</div>
                  </td>
                </tr>
                </tbody>
              </table>
      ...
      <div class="row d-none d-xl-block">
        <div class="col" v-if="dataReturnArrays">
          <div class="row" v-for="(item, k) in dataReturnArrays.point" :key="k"
               :class="{ 'bg-grey': k % 2, 'bg-white': !(k % 2) }">
            <div class="col-xl-4">
              <div class="kyc-info-box">
                <div class="row">
                  <div class="col-6 kyc-label mb-0" v-if="dataReturnArrays.column1[k]">{{
                    dataReturnArrays.column1[k].name }}
                  </div>
                  <div class="col-6 kyc-value mb-0" v-if="dataReturnArrays.column1[k]">{{
                    dataReturnArrays.column1[k].value }}
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-4">
              <div class="kyc-info-box">
                <div class="row">
                  <div class="col-6 kyc-label mb-0" v-if="dataReturnArrays.column2[k]">{{
                    dataReturnArrays.column2[k].name }}
                  </div>
                  <div class="col-6 kyc-value mb-0" v-if="dataReturnArrays.column2[k]">{{
                    dataReturnArrays.column2[k].value }}
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-4">
              <div class="kyc-info-box">
                <div class="row">
                  <div class="col-6 kyc-label mb-0" v-if="dataReturnArrays.column3[k]">{{
                    dataReturnArrays.column3[k].name }}
                  </div>
                  <div class="col-6 kyc-value mb-0" v-if="dataReturnArrays.column3[k]">{{
                    dataReturnArrays.column3[k].value }}
                  </div>
                </div>
              </div>
            </div>
    ...
    <el-dialog
      ...
      <div class="container-fluid" v-if="docSupportListFromHistoryTable && docSupportListFromHistoryTable.supportDocs">
        ...
        <div class="row" v-for="(item, k) in docSupportListFromHistoryTable.supportDocs" :key="k"
             :class="{ 'bg-grey': !(k % 2), 'bg-white': k % 2 }">
          <div class="col-3">{{item.fileName}}</div>
          <div class="col-3">{{item.uploadDate | dateFormat}}</div>
          <div class="col-3">{{item.operatorName}}</div>
          <div class="col-3">
            <button class="action-button" type="button" @click.stop.prevent="doDownloadSupportDoc(item)"
